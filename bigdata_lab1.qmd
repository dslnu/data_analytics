...
1. Pick your own dataset from Kaggle or HuggingFace or <https://archive.ics.uci.edu>. Perform numerical and object types conversions aimed at minimizing storage space, as outlined above.
2. Fix the Numba issue related to missing `int()` (more context here: https://github.com/numba/numba/issues/5650)
