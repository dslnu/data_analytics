...
1. Go through the tutorial on Black-Scholes option pricing (<https://louis-finegan.github.io/2024/10/10/Black-Scholes.html>). Modify the code so that:
  - it works for some different company
  - uses Cython as much as possible
  - measure results
