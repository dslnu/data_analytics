...
1. Generators optimize for memory.
2. Sometimes lists might be faster (but still use more memory)
3. Used in streaming applications.
:::
<!-- Reading a log file: -->
...
<!-- log_file_path = '_files/depression_data.csv'; -->
